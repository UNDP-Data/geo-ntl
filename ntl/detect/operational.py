...
if __name__ == '__main__':
    ...
    from ntl.io.operational import d
    a3 = '/tmp/VNP46A3.A2026060.h23v05.002.2026099180914.h5'
    geo_file = '/tmp/GDNBO_j02_d20260415_t2129285_e2130532_b17771_c20260415221007936000_oebc_ops.h5'
    cloud_nc = '/tmp/JRR-CloudMask_v3r2_n21_s202604152129285_e202604152130532_c202604152221009.nc'
    sdr_hdf='/tmp/SVDNB_j02_d20260415_t2129285_e2130532_b17771_c20260415221319800000_oebc_ops.h5'
    bboxes = [
    ...
    baseline, lwm,  indices = reproject_46a3_to_swath(science_hdf=a3,oper_geo_hdf=geo_file, bbox=bbox, pad=20)
    ...
    print(baseline.shape, cmask.shape, rad.shape)
    ...
    if len(x_clean) > 10:
        ...
        d_thresh = calculate_dynamic_threshold(y_clean, x_clean, multiplier=1.8)
        #d_thresh = 1
        # Run your NumPy-only RANSAC
        slope, intercept = ransac(x_clean, y_clean, iterations=200, threshold=d_thresh)
